...
class PomeloDatasetOrganizer:
    ...
    def __init__(
        self,
        google_drive_images_folder: str = r"https://drive.google.com/drive/folders/1gR0VR5mHSoE-6yek0rX-igIBNNYxlJ4S?usp=drive_link",
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=r"https://drive.google.com/drive/folders/1gR0VR5mHSoE-6yek0rX-igIBNNYxlJ4S?usp=drive_link",
