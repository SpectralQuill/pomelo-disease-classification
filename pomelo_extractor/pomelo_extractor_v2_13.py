...
class PomeloExtractor:
    ...
    def _visualize_mask(self, image_rgb, mask, score, mask_index, center_point, chosen=False,
        ...
        text_color = [255, 0, 0]
        mask_text = f"Mask {mask_index + 1}{' (Overridden)' if mask_overridden else ' (Selected)' if chosen else ''}"
...
if __name__ == "__main__":
    ...
    IGNORE_SUBFOLDERS = {'bad_images', 'test'}  # Example of subfolders to ignore
